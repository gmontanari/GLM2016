...
head(out.sum)
```
### Si quiero estimar de manera puntual Beta1: esta alrededor de -1.69 con un desvío de 0.76. Beta 2: alrededor de 0.83 con un desvio de 0.15.Como esta es la media, es la funcion de pérdida cuadrática la que estoy usando para mi función de  pérdida.
