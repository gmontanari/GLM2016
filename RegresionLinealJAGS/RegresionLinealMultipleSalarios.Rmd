...
```{r}
salarios2<-scale(salarios)
x1f2<-(c(5.4,6.2,6.4)-5.4)/1.29
x2f2<-(c(17,12,21)-25)/11.22
x3f2<-(c(6.0,5.8,6.1)-6)/1.3
...
Cargo los datos escalados a una lista para que JAGS los pueda leer

```{r}
data <- list("n" = n,"y"=salarios2$Y,"x1"=salarios2$X1,"x2"=salarios2$X2,
             "x3"=salarios2$X3,"x1f"=x1f2,"x2f"=x2f2,"x3f"=x3f2,"m"=m)
```
